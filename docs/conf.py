...
# -*- coding: utf-8 -*-
#
# kalasiris documentation build configuration file, created by
...
version = kalasiris.__version__
# The full version, including alpha/beta/rc tags.
release = kalasiris.__version__
...
htmlhelp_basename = 'kalasirisdoc'
...
latex_documents = [
    (master_doc, 'kalasiris.tex',
     u'kalasiris Documentation',
     u'Ross A. Beyer', 'manual'),
]
